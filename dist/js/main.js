...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_adminbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/adminbar */ "./assets/js/components/adminbar.js");
/* harmony import */ var _components_adminbar__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_adminbar__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_header_scrolled__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/header-scrolled */ "./assets/js/components/header-scrolled.js");
/* harmony import */ var _components_header_scrolled__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_header_scrolled__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_navigation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/navigation.js */ "./assets/js/components/navigation.js");
/* harmony import */ var _components_skip_link_focus_fix__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/skip-link-focus-fix */ "./assets/js/components/skip-link-focus-fix.js");
/* harmony import */ var _components_skip_link_focus_fix__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_skip_link_focus_fix__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _components_to_top__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/to-top */ "./assets/js/components/to-top.js");
...
/* harmony import */ var _components_ajax__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/ajax */ "./assets/js/components/ajax.js");
/* harmony import */ var _components_ajax__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_ajax__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_cf7_events__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/cf7-events */ "./assets/js/components/cf7-events.js");
/* harmony import */ var _components_cf7_events__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_cf7_events__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _components_table_of_content__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/table-of-content */ "./assets/js/components/table-of-content.js");
/* harmony import */ var _components_table_of_content__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_components_table_of_content__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var _components_modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/modal */ "./assets/js/components/modal.js");
...
/* harmony import */ var _components_tabs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/tabs */ "./assets/js/components/tabs.js");
...
/* harmony import */ var _components_toggle__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/toggle */ "./assets/js/components/toggle.js");
/* harmony import */ var _components_toggle__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_components_toggle__WEBPACK_IMPORTED_MODULE_11__);
// Custom components:
 // Toggle Adminbar display

 // Handle scrolled header behavior

 // Toggle mobile menu and sub-menus
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vars__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_vars */ "./assets/js/_vars.js");
/* harmony import */ var _functions_throttle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/throttle */ "./assets/js/functions/throttle.js");
...
/* harmony import */ var _vendors_jquery_nice_select_min_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendors/jquery.nice-select.min.js */ "./assets/js/vendors/jquery.nice-select.min.js");
/* harmony import */ var _vendors_jquery_nice_select_min_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_vendors_jquery_nice_select_min_js__WEBPACK_IMPORTED_MODULE_3__);
...
jQuery(document).ready(function ($) {
  ...
  const fixFullheight = () => {
    ...
    _vars__WEBPACK_IMPORTED_MODULE_0__["default"].htmlEl.style.setProperty('--vh', `${vh}px`);
  };

  fixFullheight();
  const fixHeight = (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_1__.throttle)(fixFullheight);
  ...
  if ($('.m-counter').length > 0) {
    document.querySelectorAll('.m-counter__slider-swiper').forEach(slider => {
      const swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_2__["default"](slider, {
        spaceBetween: 24,
        loop: true,
        speed: 5000,
        slidesPerView: 1,
  ...
  if ($('.m-separator__swiper').length > 0) {
    document.querySelectorAll('.m-separator__swiper').forEach(slider => {
      ...
      const initSwiper = () => {
        swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_2__["default"](slider, {
          loop: true,
          slidesPerView: 1,
          breakpoints: {
            640: {
  ...
  if ($('.m-partnership').length > 0) {
    document.querySelectorAll('.m-partnership__swiper-top').forEach(slider => {
      ...
      new swiper_bundle__WEBPACK_IMPORTED_MODULE_2__["default"](slider, {
        slidesPerView: 'auto',
        spaceBetween: 20,
        loop: true,
        speed: 6000,
  ...
  function observeElements(selector, callback) {
    ...
    checkElements(); // Refresh with restored scroll position
  ...
  function animateCounter(element) {
    var _finalValue$match, _finalValue$match2;

    const $counter = $(element);
    const finalValue = $counter.data('counter').toString();
    const target = parseInt(finalValue.replace(/\D/g, ''), 10);
    const prefix = ((_finalValue$match = finalValue.match(/^\D*/)) === null || _finalValue$match === void 0 ? void 0 : _finalValue$match[0]) || '';
    const suffix = ((_finalValue$match2 = finalValue.match(/\D*$/)) === null || _finalValue$match2 === void 0 ? void 0 : _finalValue$match2[0]) || '';
    ...
    $({
      ...
      duration: 2500,
      step: function (value) {
        $counter.text(prefix + Math.floor(value) + suffix);
      },
      complete: function () {
  ...
  observeElements('.animated-item .counter-item__title[data-counter]', animateCounter); // Sticky Header Script
...
jQuery(document).ready(function ($) {
  ...
  $(document).on('click', '.js-accordion-title', function () {
    ...
    if (accordionItem.hasClass('is-open')) {
      ...
      accordionItem.find('.js-accordion-content').stop().slideUp();
    } else {
      ...
      accordionItem.find('.js-accordion-content').stop().slideDown();
    }
  });
});
...
jQuery(document).ready(function ($) {
  ...
  document.addEventListener('wpcf7submit', function (event) {
    ...
    if ('123' === event.detail.contactFormId) {
      console.log("The contact form ID is 123."); // do something productive
    }
  }, false);
});
...
jQuery(document).ready(function ($) {
  ...
  function closeMobileMenu() {
    ...
    if ($(window).width() >= _vars__WEBPACK_IMPORTED_MODULE_0__["default"].bp.lg) {
      if ($('body').hasClass('is-menu-open')) {
...
/***/ "./assets/js/components/table-of-content.js":
/*!**************************************************!*\
  !*** ./assets/js/components/table-of-content.js ***!
  \**************************************************/
/***/ (function() {
...
jQuery(document).ready(function ($) {
  ...
  if ($('.single-resource').length > 0) {
    ...
    postWrapper.find('h2, h3, h4, h5, h6').each(function (index, element) {
      ...
      let listItem = $('<li class="heading-' + headingTag + '">' + '<a href="#" data-heading="' + headingId + '">' + headingText + '</a>' + '</li>');
      tocList.append(listItem);
      hasHeadings = true;
    });
    hasHeadings ? tocListWrapper.removeClass('hidden') : tocListWrapper.remove();
...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_components */ "./assets/js/_components.js");
/* harmony import */ var _custom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_custom */ "./assets/js/_custom.js");
// Main JS file
 // Custom components
