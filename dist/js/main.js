...
/* harmony import */ var _components_woocommerce__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/woocommerce */ "./assets/js/components/woocommerce.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_throttle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions/throttle */ "./assets/js/functions/throttle.js");
...
jQuery(document).ready(function ($) {
  ...
  function updateProductQty(that) {
    ...
    let qty = that.closest('.quantity').find('.qty'),
        ...
        totalQty = val; // Change the value if plus or minus
  ...
  if (sliderProductImage) {
    swiperProductThumbs = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](sliderProductThumbs, {
      spaceBetween: 20,
      slidesPerView: 3,
    ...
    swiperProductImage = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](sliderProductImage, {
      spaceBetween: 10,
      watchSlidesProgress: true,
      navigation: {
  ...
  document.querySelectorAll('.swiper-products').forEach(slider => {
    const swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](slider, {
      spaceBetween: 10,
      breakpoints: {
        576: {
          slidesPerView: 2,
  ...
  window.addEventListener('resize', () => {
    document.querySelectorAll('.swiper').forEach(slider => (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_0__.throttle)(toggleSliderButtons(slider)));
  });
  /**
  ...
  if ($('form.variations_form').length) {
    ...
    function resetFirstSlideToOriginal() {
      ...
      firstSlide.querySelector('img').setAttribute('srcset', firstSlideOriginal.srcset); // slider product thumbnails:
      ...
      if ('' !== $(this).val()) {
        ...
        if (Object.keys(filteredData).length !== 0) {
          ...
          if (slideIndexGoTo === 0) {
            ...
            firstSlide.querySelector('img').setAttribute('srcset', varObj.image.srcset); // slider product thumbnails:
